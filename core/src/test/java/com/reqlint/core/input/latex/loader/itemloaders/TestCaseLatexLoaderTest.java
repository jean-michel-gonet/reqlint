...
class TestCaseLatexLoaderTest {
    ...
    private TestCaseLatexLoader underTest;

    @BeforeEach
    public void setUp() {
        underTest = new TestCaseLatexLoader();
    }
    ...
    public void can_load_its_content() throws Exception {
        ...
        TestCase testCase = underTest.specificationItem();
        Assertions.assertThat(testCase.identifier()).isEqualTo(IDENTIFIER);
        Assertions.assertThat(testCase.title()).isEqualTo(TITLE);
        Assertions.assertThat(testCase.childOf()).containsExactly(CHILD_OF_1, CHILD_OF_2);
    }
    ...
    public void can_load_a_test_procedure() throws Exception {
        ...
        TestProcedure testProcedure = underTest.specificationItem().testProcedure();
