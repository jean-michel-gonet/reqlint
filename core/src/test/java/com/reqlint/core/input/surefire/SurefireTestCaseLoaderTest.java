...
class SurefireTestCaseLoaderTest {
    ...
    public void can_parse_a_test_with_one_stage_without_expectation() {
        ...
        Assertions.assertThat(testRun.title()).isEqualTo(TEST_NAME);
        Assertions.assertThat(testRun.timeStamp()).isEqualTo(NOW);

        Assertions.assertThat(testRun.preparation()).isNull();
        ...
        Assertions.assertThat(testRun.stages()).containsExactly(expectedStage1);
    }
    ...
    public void can_parse_a_test_with_no_preparation_and_two_stages() {
        ...
        Assertions.assertThat(testRun.stages()).contains(expectedStage1);
        Assertions.assertThat(testRun.stages()).contains(expectedStage2);
        Assertions.assertThat(testRun.stages()).containsExactly(expectedStage1, expectedStage2);
    }

    @Test
    public void can_parse_a_test_as_a_single_string() {
        TestRun testRun = underTest
        ...
        Assertions.assertThat(testRun.preparation()).isNotNull();
        Assertions.assertThat(testRun.stages()).hasSize(1);
    ...
    public void can_parse_a_test_with_one_preparation_and_one_stage() {
        ...
        Assertions.assertThat(testRun.stages()).containsExactly(expectedStage);
    }
